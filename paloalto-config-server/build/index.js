            ...
            try {
                switch (request.params.name) {
                    case 'get_configuration': {
                        ...
                        const response = await this.axiosInstance.get('/config/get', {
                            params: { xpath },
                        });
                        return {
                            content: [
                    ...
                    case 'set_configuration': {
                        const { xpath, element } = request.params.arguments;
                        const response = await this.axiosInstance.post('/config/set', {
                            xpath,
                            element,
                        });
                        return {
                    ...
                    case 'delete_configuration': {
                        const { xpath } = request.params.arguments;
                        const response = await this.axiosInstance.delete('/config/delete', {
                            params: { xpath },
                        });
                        return {
                            content: [
                    ...
                    case 'move_configuration': {
                        const { xpath, where, dst } = request.params.arguments;
                        const response = await this.axiosInstance.post('/config/move', {
                            xpath,
                            where,
                            dst,
                        });
                    ...
                    case 'rename_configuration': {
                        const { xpath, newname } = request.params.arguments;
                        const response = await this.axiosInstance.post('/config/rename', {
                            xpath,
                            newname,
                        });
                        return {
                    ...
                    case 'clone_configuration': {
                        const { xpath, newname } = request.params.arguments;
                        const response = await this.axiosInstance.post('/config/clone', {
                            xpath,
                            newname,
                        });
                        return {
